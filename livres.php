...
$sql = "SELECT * FROM documents WHERE categorie = 'Livres'";  // Vérifie que 'Thèse' est bien utilisé ici
...
<head>
    ...
    <title>Livres - Club Histoire</title>
       ...
       <a href="accueil.html"> <!-- Lien vers la page d'accueil -->
        ...
        <nav>
            <ul>
                ...
                <li><a href="theses.php">Thèses</a></li>
                <li><a href="livres.php">Livres</a></li>
                <li><a href="articles.php">Articles</a></li>
                <li><a href="memoires.php">Mémoires</a></li>
