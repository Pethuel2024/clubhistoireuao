...
$sql = "SELECT * FROM documents WHERE categorie = 'Documents rares'";  // Vérifie que 'Thèse' est bien utilisé ici
...
<head>
    ...
    <title>Documents rares - Club Histoire</title>
...
<body>
  <header>
        ...
        <h1>Documents rares Disponibles</h1>
        <nav>
            <ul>
    ...
    <div class="docrares-list">
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<p>Aucun documents rares trouvé.</p>";
        }
        ?>
    </div>
    <footer>
