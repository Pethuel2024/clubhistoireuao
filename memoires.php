...
$sql = "SELECT * FROM documents WHERE categorie = 'Mémoires de l''UAO'";  // Vérifie que 'Thèse' est bien utilisé ici
...
<head>
    ...
    <title>Mémoires - Club Histoire</title>
