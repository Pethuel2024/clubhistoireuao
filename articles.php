...
$sql = "SELECT * FROM documents WHERE categorie = 'Articles de l''UAO'";  // Vérifie que 'Thèse' est bien utilisé ici
...
<head>
    ...
    <title>articles - Club Histoire</title>
  ...
  <header>
    ...
    <div class="articles-list">
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<p>Aucun Articles trouvé.</p>";
        }
        ?>
    </div>
    <footer>
