...
$sql = "SELECT * FROM documents WHERE categorie = 'Thèses de l''UAO'";  // Vérifie que 'Thèse' est bien utilisé ici
...
<head>
    ...
    <title>Thèsess - Club Histoire</title>
...
<body>
    ...
    <div class="theses-list">
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<p>Aucune Thèses trouvée.</p>";
        }
        ?>
    </div>
    <footer>
